      ...
      <div className="flex flex-1 flex-col p-4">
        <AnimatePresence mode="wait">
          {loading ? (
            ...
            <motion.div key={result.resultText} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="flex flex-1 flex-col">
              ...
              <p className="flex-1 whitespace-pre-wrap text-lg leading-relaxed">{result.resultText}</p>
              {result.culturalNote && (
